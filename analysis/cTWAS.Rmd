...
GABA.pip1 <- GABA.pip1[order(GABA.pip1$PIP_diff,decreasing=T),]
...
nmglut.pip1 <- nmglut.pip1[order(nmglut.pip1$PIP_diff,decreasing=T),]
...
npglut.pip1 <- npglut.pip1[order(npglut.pip1$PIP_diff,decreasing=T),]
