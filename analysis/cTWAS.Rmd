...
Most top gene PIPs were overestimated in the initial run. There are 17 genes with PIP sums greater than 0.8 for the GABA cell type. Only 2 genes cross the threshold in both Glut cell types.
