...
eGenes for each condition (the combination of cell type and time point) was selected with two criteria: (1) At least one SNP-gene pair has FDR<0.05 in any time point within the same cell type; (2) P value < 0.1 for the current condition. The number of genes for different settings were shown below:
